...
import com.ylpu.kepler.scheduler.jmx.MasterJmxServer;
import com.ylpu.kepler.scheduler.manager.strategy.JobStrategy;
import com.ylpu.kepler.scheduler.manager.strategy.ResourceStrategy;
import com.ylpu.kepler.scheduler.manager.strategy.ResourceStrategyContext;
import com.ylpu.kepler.scheduler.manager.strategy.WorkerSelectStrategy;
...
import com.ylpu.kepler.scheduler.rest.MasterRestServer;
import com.ylpu.kepler.scheduler.rpc.client.JobCallBackScan;
import com.ylpu.kepler.scheduler.rpc.server.MasterRpcServer;
...
public class MasterManager{
    ...
    public void init() throws Exception{
        ...
        prop.put("kepler.zookeeper.quorum", GlobalConstants.DEFAULT_ZKQUORUM);
        prop.put("kepler.zookeeper.sessionTimeout", GlobalConstants.ZOOKEEPER_SESSION_TIMEOUT);
        prop.put("kepler.zookeeper.connectionTimeout", GlobalConstants.ZOOKEEPER_CONNECTION_TIMEOUT);
        init(prop);
    }
    ...
    public void init(Properties prop) throws Exception{
        ...
        int masterServerPort = Configuration.getInt(prop,"kepler.master.server.port",DEFAULT_MASTER_SERVER_PORT);
...
//      初始化每台机器运行的任务个数,供监控使用
        initTaskCount();
//      启动jmx服务
        agent = new MasterJmxServer(Configuration.getInt(prop, "kepler.master.jmx.port", DEFAULT_JMX_PORT));
        agent.start();
//      启动master rpc服务
    ...
    public synchronized WorkerResponse getIdleWorker(String groupName,String... lastFailedWorkers) {
        String workerStrategy = Configuration.getString(Configuration.getConfig(GlobalConstants.CONFIG_FILE),
                "kepler.scheduler.worker.strategy",GlobalConstants.DEFAULT_WORKER_STRATEGY);
