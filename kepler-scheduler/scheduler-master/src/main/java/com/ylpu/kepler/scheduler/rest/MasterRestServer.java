package com.ylpu.kepler.scheduler.rest;
...
public class MasterRestServer {
    ...
    public void startJettyServer() throws Exception {
        ...
        int jettyServerPort = Configuration.getInt(prop,"kepler.master.service.port",JETTY_SERVER_PORT);
        ...
        servletHolder.setInitParameter("com.sun.jersey.config.property.packages",
                "com.ylpu.kepler.scheduler.rest.resources");
