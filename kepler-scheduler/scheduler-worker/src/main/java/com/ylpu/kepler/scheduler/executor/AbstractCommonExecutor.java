...
import com.ylpu.kepler.scheduler.rpc.server.WorkerRpcServiceImpl;
...
public abstract class AbstractCommonExecutor{
    ...
    public void execute() throws Exception{
        ...
        int logServerPort = Configuration.getInt(prop, "kepler.log.server.port", LOG_SERVER_PORT);
        
        String logDir = Configuration.getString(prop, "kepler.worker.log.path", DEFAULT_LOG_DIR);
