...
import com.ylpu.kepler.scheduler.core.enums.OSInfo;
...
//             killLinuxProcess(3l); 
             int pid = 65633;
             TaskProcessUtils.execCommand("/Users/admin/kepler/kepler-scheduler/scheduler-worker/src/script/kill.sh", 
