...
//    }
    ...
    @ResponseBody
    @RequestMapping(value = "/getDateSummary", method = RequestMethod.GET)
    public SchedulerResponse<List<DateSummaryResponse>> getDateSummary() {
        return new SchedulerResponse<List<DateSummaryResponse>>(jobInstanceService.getDateSummary());
    }
