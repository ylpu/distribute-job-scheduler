    ...
    public static JobRequestRpc setJobRequest(JobResponse response) {
        ...
        if(dependencies != null && dependencies.size() > 0) {
            for(JobResponse dependency : dependencies) {
                ...
                .setJobReleasestate(dependency.getJobReleasestate() == null ? JobReleaseState.ONLINE.getCode() : JobReleaseState.getJobReleaseStateByName(response.getJobReleasestate()).getCode())
        ...
        JobRequestRpc rpcJobRequest = JobRequestRpc.newBuilder()
                ...
                .setJobReleasestate(response.getJobReleasestate() == null ? JobReleaseState.ONLINE.getCode() : JobReleaseState.getJobReleaseStateByName(response.getJobReleasestate()).getCode())
