package com.ylpu.thales.scheduler.master.api.server;
...
public class MasterApiServer {
    ...
    private static Log LOG = LogFactory.getLog(MasterApiServer.class);
    ...
    public MasterApiServer(Properties prop) {
        this.prop = prop;
    }
...
//        config.configure(server);
        ...
        servletHolder.setInitParameter("com.sun.jersey.config.property.packages",
                "com.ylpu.thales.scheduler.master.api.resources");
